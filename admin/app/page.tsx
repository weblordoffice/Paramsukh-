...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        if (error === 'not_admin') {
            toast.error('This Google account is not an admin. Ask a super admin to add your email in Settings.');
        }
    }, [searchParams]);
            ...
            <div className="w-full max-w-md">
                <div className="bg-white rounded-2xl shadow-2xl p-8 space-y-6">
                    ...
                    <p className="text-center text-sm text-gray-500">
                        Only accounts added by a super admin can sign in. Use the same Google email that was added in Settings.
                    </p>
                </div>
            </div>
        </div>
